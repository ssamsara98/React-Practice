...
export const BurgerBuilder = (props: any) => {
	...
	const price = useSelector((state: any) => state.burgerBuilder.totalPrice);
	const error = useSelector((state: any) => state.burgerBuilder.error);
	const isAuthenticated = useSelector(
		(state: any) => state.auth.token !== null
	);

	const onIngredientAdded = (ingName: any) =>
		dispatch(actions.addIngredient(ingName));
	const onIngredientRemoved = (ingName: any) =>
	...
	const onSetAuthRedirectPath = (path: any) =>
